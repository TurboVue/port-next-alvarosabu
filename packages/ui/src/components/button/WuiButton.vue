...
/* Unstyled */
.wui-btn {
  @apply rounded-sm cursor-pointer flex-wrap
  flex-shrink-0 text-center transition ease-in-out duration-200 inline-flex items-center justify-center select-none;
